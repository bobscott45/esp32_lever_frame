...
* **Waveshare ESP32-S3-Touch-LCD-4.3** (Part Number/SKU: **25948**).
  ...
  * **⚠️ Hardware Power Flaw:** Out of the box, waking the screen from sleep can cause a voltage brownout and crash the ESP32 due to the backlight inrush current. As detailed in Pieter van Ginkel's Medium article on these boards, you can permanently fix this by soldering a **100uF - 470uF capacitor** across the GND and VOUT pins of the 3.3V LDO.
  * **⚠️ Hardware Dimming Flaw:** The backlight enable pin is wired through a digital CH422G I/O expander, making screen dimming and soft-starting physically impossible on this board.
