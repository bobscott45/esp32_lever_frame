...
* **Waveshare ESP32-S3-Touch-LCD-4.3** (Part Number/SKU: **25948**).
  ...
  * **⚠️ Hardware Power Flaw:** Out of the box, waking the screen from sleep can cause a voltage brownout and crash the ESP32 due to the backlight inrush current. As detailed in [Pieter van Ginkel's Medium article](https://medium.com/@pvginkel/brownout-issues-with-waveshares-esp32-s3-touch-lcd-4-3-c61105220b4c) on these boards, you can permanently fix this by soldering a capacitor across the GND and VOUT pins of the 3.3V LDO. (Note: A 100uF capacitor has been successfully tested and confirmed to resolve this issue).
* **Waveshare ESP32-P4-WIFI6-Touch-LCD-4.3** display module.
  * **Note:** The P4 offers a cleaner, snappier display with absolutely no UI tearing, but it comes at the cost of shorter battery life compared to the S3. The P4 board does **not** suffer from the brownout flaws of the S3.
